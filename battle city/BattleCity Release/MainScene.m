...
- (id)initWithMapInformation:(int)leve status:(int)status life:(int)life {
    ...
    if (self != nil){
        ...
        ipLife.position = ccp(30,_winSize.height - 150);
        ...
        ipLifeIcok.position = ccp(20,_winSize.height - 170);
        ...
        flag.position  = ccp(_winSize.width - 50 , _winSize.height - 300);
        [self addChild:flag];
        [self showLeve:leve];
...
- (void)showLife:(int)numLife {
    ...
    _1plifeString.position = ccp(45,_winSize.height - 170);
