...
- (void)menuItem1Touch {
    ...
    if (_leve+1 > 20){
        ...
        [[NSUserDefaults standardUserDefaults]setValue:[NSNumber numberWithInt:_leve+1] forKey:@"currentLevel"];
        [[NSUserDefaults standardUserDefaults]synchronize];
       
        MainScene* scene = [[MainScene alloc] initWithMapInformation:_leve+1 status:_kind life:5];
